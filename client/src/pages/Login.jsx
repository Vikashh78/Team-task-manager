    ...
    <div className="min-h-screen gradient-mesh flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md fade-in">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="font-display font-bold text-3xl text-white">TeamFlow</h1>
        ...
        <div className="mt-4 p-4 rounded-xl border border-white/5 bg-white/[0.02] text-center">
          <p className="text-xs text-slate-500">
            Sign up with role <span className="text-blue-400 font-mono">Admin</span> to manage projects & team,
            or <span className="text-slate-400 font-mono">Member</span> to view assigned tasks.
          </p>
        </div>
      </div>
    </div>
